...
//@
`include "define.v"
`define WGT_EXT (19 - `WGT_WIDTH)
`define PIX_EXT (10 - `PIX_WIDTH)

module FixedPointMultiplier (
  input clk,
  input GlobalReset,
  input [`WGT_WIDTH-1:0] WeightPort, // sfix19_En18
  input [`PIX_WIDTH-1:0] PixelPort, // sfix10_En0
...
wire GlobalResetSel;
  ...
  assign N_3 = {WeightPort, {(`WGT_EXT){1'b0}}}; // zero extend to 19 bits
  assign N_2 = {{(`PIX_EXT){1'b0}}, PixelPort}; // zero extend to 10 bits
